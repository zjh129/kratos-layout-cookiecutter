...
type {{ cookiecutter.__app_name_camel }}Service struct {
	{{ cookiecutter.__app_name_camel }}.Unimplemented{{ cookiecutter.__app_name_camel }}Server
...
func (s *{{ cookiecutter.__app_name_camel }}Service) SayHello(ctx context.Context, in *{{ cookiecutter.__app_name_camel }}.HelloRequest) (*{{ cookiecutter.__app_name_camel }}.HelloReply, error) {
