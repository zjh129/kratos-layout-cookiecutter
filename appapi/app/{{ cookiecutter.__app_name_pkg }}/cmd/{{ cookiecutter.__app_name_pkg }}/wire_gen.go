...
func wireApp(confServer *conf.Server, confData *conf.Data, logger log.Logger) (*kratos.App, func(), error) {
	...
	{{ cookiecutter.__app_name_camel }}Repo := data.New{{ cookiecutter.app_name_camel }}Repo(dataData, logger)
	{{ cookiecutter.__app_name_camel }}Usecase := biz.New{{ cookiecutter.app_name_camel }}Usecase({{ cookiecutter.__app_name_camel }}Repo, logger)
	{{ cookiecutter.__app_name_camel }}Service := service.New{{ cookiecutter.app_name_camel }}Service({{ cookiecutter.__app_name_camel }}Usecase)
